...
<div id="btnBox">
  <input type="button" title="เพิ่มรายงาน คปญ.04 แผนการดำเนินงาน" value="เพิ่มรายงาน คปญ.04" onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=form4'" class="btn btn-warning vtip" />
</div>
