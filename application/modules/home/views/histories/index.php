...
<form method="get" class="form-inline">
  <div class="col-xs-4">
    <input type="text" class="form-control" placeholder="ชื่อ - สกุล, เลขบัตรประจำตัวประชาชน" name="search" value="<?=@$_GET['search']?>">
  </div>
...
<div id="btnBox">
  <a href="home/histories/form"><input type="button" title="เพิ่มโครงการ" value="เพิ่มรายการ" class="btn btn-warning vtip" /></a>
</div>
